 ...
 */
// 切换收藏状态
export const toggleFavorite = (p) => post('/file/favorite', p)
// 获取收藏文件列表
export const getFavoriteFileList = (p) => get('/file/getfavoritefilelist', p)
// 按标签获取文件列表
export const getFileListByTag = (p) => get('/file/getfilelistbytag', p)
