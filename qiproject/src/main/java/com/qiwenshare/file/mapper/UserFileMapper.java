...
public interface UserFileMapper extends BaseMapper<UserFile> {
    ...
    IPage<FileListVO> selectFavoritePageVo(Page<?> page, @Param("userFile") UserFile userFile);
    IPage<FileListVO> selectPageVoByTag(Page<?> page, @Param("userFile") UserFile userFile, @Param("tagId") Long tagId);
